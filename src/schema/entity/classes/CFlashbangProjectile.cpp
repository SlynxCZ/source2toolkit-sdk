...
CFlashbangProjectile* CFlashbangProjectile::EmitGrenade(const Vector& vecPosition, const QAngle& angAngle, const Vector& vecVelocity,
...
#ifdef SOURCE2TOOLKIT_CORE
    return addresses::toolkitAddresses.CFlashbangProjectile_EmitGrenade()(&vecPos, &angAng, &vecVel, &vecVel, pOwner, nItemDefIndex);
#else
    return g_ToolkitAPI->Addresses()->CFlashbangProjectile_EmitGrenade()(&vecPos, &angAng, &vecVel, &vecVel, pOwner, nItemDefIndex);
#endif
}
