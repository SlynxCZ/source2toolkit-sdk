...
CDecoyProjectile* CDecoyProjectile::EmitGrenade(const Vector& vecPosition, const QAngle& angAngle, const Vector& vecVelocity,
...
#ifdef SOURCE2TOOLKIT_CORE
    return addresses::toolkitAddresses.CDecoyProjectile_EmitGrenade()(&vecPos, &angAng, &vecVel, &vecVel, pOwner, nItemDefIndex);
#else
    return g_ToolkitAPI->Addresses()->CDecoyProjectile_EmitGrenade()(&vecPos, &angAng, &vecVel, &vecVel, pOwner, nItemDefIndex);
#endif
}
