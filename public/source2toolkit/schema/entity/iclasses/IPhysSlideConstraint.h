...
#ifndef _INCLUDE_IPHYSSLIDECONSTRAINT_H
#define _INCLUDE_IPHYSSLIDECONSTRAINT_H
...
public:
    ...
    virtual float& SlideFriction() = 0;
    virtual void SlideFrictionUpdated() = 0;
    virtual float& SystemLoadScale() = 0;
    virtual void SystemLoadScaleUpdated() = 0;
    virtual float& InitialOffset() = 0;
    virtual void InitialOffsetUpdated() = 0;
