...
#ifndef _INCLUDE_IIRONSIGHTCONTROLLER_H
#define _INCLUDE_IIRONSIGHTCONTROLLER_H
...
public:
    ...
    virtual float& IronSightAmount() = 0;
    virtual void IronSightAmountUpdated() = 0;
    virtual float& IronSightAmountGained() = 0;
