...
#ifndef _INCLUDE_IPULSEGRAPHINSTANCE_SERVERENTITY_H
#define _INCLUDE_IPULSEGRAPHINSTANCE_SERVERENTITY_H
...
public:
    ...
    virtual void ActivatedUpdated() = 0;
    virtual CUtlSymbolLarge& NameFixupStaticPrefix() = 0;
    virtual void NameFixupStaticPrefixUpdated() = 0;
    virtual CUtlSymbolLarge& NameFixupParent() = 0;
    virtual void NameFixupParentUpdated() = 0;
    virtual CUtlSymbolLarge& NameFixupLocal() = 0;
