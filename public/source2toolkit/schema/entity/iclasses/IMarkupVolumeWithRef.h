...
#ifndef _INCLUDE_IMARKUPVOLUMEWITHREF_H
#define _INCLUDE_IMARKUPVOLUMEWITHREF_H
...
public:
    ...
    virtual Vector& RefPosEntitySpace() = 0;
    virtual void RefPosEntitySpaceUpdated() = 0;
    virtual Vector& RefPosWorldSpace() = 0;
