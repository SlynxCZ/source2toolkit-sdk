...
#ifndef _INCLUDE_IENVPARTICLEGLOW_H
#define _INCLUDE_IENVPARTICLEGLOW_H
...
public:
    ...
    virtual float& RadiusScale() = 0;
    virtual void RadiusScaleUpdated() = 0;
    virtual float& SelfIllumScale() = 0;
    virtual void SelfIllumScaleUpdated() = 0;
