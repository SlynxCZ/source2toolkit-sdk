...
#ifndef _INCLUDE_ITANKTRAINAI_H
#define _INCLUDE_ITANKTRAINAI_H
...
public:
    ...
    virtual int32_t& SoundPlaying() = 0;
    virtual void SoundPlayingUpdated() = 0;
    virtual CUtlSymbolLarge& StartSoundName() = 0;
    virtual void StartSoundNameUpdated() = 0;
    virtual CUtlSymbolLarge& EngineSoundName() = 0;
    virtual void EngineSoundNameUpdated() = 0;
    virtual CUtlSymbolLarge& MovementSoundName() = 0;
