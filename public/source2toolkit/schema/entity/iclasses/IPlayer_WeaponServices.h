...
#ifndef _INCLUDE_IPLAYER_WEAPONSERVICES_H
#define _INCLUDE_IPLAYER_WEAPONSERVICES_H
...
public:
    ...
    virtual CHandle<CBasePlayerWeapon>& ActiveWeapon() = 0;
    virtual void ActiveWeaponUpdated() = 0;
    virtual CHandle<CBasePlayerWeapon>& LastWeapon() = 0;
    virtual void LastWeaponUpdated() = 0;
