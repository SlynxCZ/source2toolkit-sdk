...
#ifndef _INCLUDE_IPHYSEXPLOSION_H
#define _INCLUDE_IPHYSEXPLOSION_H
...
public:
    ...
    virtual float& PushScale() = 0;
    virtual void PushScaleUpdated() = 0;
    virtual bool& ConvertToDebrisWhenPossible() = 0;
    virtual void ConvertToDebrisWhenPossibleUpdated() = 0;
    virtual bool& AffectInvulnerableEnts() = 0;
