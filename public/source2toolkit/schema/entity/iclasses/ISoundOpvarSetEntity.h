...
#ifndef _INCLUDE_ISOUNDOPVARSETENTITY_H
#define _INCLUDE_ISOUNDOPVARSETENTITY_H
...
public:
    ...
    virtual int32_t& OpvarType() = 0;
    virtual void OpvarTypeUpdated() = 0;
    virtual int32_t& OpvarIndex() = 0;
    virtual void OpvarIndexUpdated() = 0;
    virtual float& OpvarValue() = 0;
    virtual void OpvarValueUpdated() = 0;
    virtual CUtlSymbolLarge& OpvarValueString() = 0;
