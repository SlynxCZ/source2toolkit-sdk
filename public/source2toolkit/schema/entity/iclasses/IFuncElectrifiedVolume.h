...
#ifndef _INCLUDE_IFUNCELECTRIFIEDVOLUME_H
#define _INCLUDE_IFUNCELECTRIFIEDVOLUME_H
...
public:
    ...
    virtual CUtlSymbolLarge& EffectInterpenetrateName() = 0;
    virtual void EffectInterpenetrateNameUpdated() = 0;
    virtual CUtlSymbolLarge& EffectZapName() = 0;
