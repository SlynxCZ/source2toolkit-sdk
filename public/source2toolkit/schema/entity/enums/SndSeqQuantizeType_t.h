...
#ifndef _INCLUDE_SNDSEQQUANTIZETYPE_T_H
#define _INCLUDE_SNDSEQQUANTIZETYPE_T_H

#pragma once

#include <cstdint>

enum class SndSeqQuantizeType_t : int32_t
{
...
#endif // _INCLUDE_SNDSEQQUANTIZETYPE_T_H
