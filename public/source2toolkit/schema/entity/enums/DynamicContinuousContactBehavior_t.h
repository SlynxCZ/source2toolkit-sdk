...
#ifndef _INCLUDE_DYNAMICCONTINUOUSCONTACTBEHAVIOR_T_H
#define _INCLUDE_DYNAMICCONTINUOUSCONTACTBEHAVIOR_T_H
...
#endif // _INCLUDE_DYNAMICCONTINUOUSCONTACTBEHAVIOR_T_H
