...
#ifndef _INCLUDE_CFUNCMOVER__FINDFOLLOWMOVERSTRATEGY_T_H
#define _INCLUDE_CFUNCMOVER__FINDFOLLOWMOVERSTRATEGY_T_H
...
#endif // _INCLUDE_CFUNCMOVER__FINDFOLLOWMOVERSTRATEGY_T_H
