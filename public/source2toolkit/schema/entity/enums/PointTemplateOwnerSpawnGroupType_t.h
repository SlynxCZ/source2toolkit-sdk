...
#ifndef _INCLUDE_POINTTEMPLATEOWNERSPAWNGROUPTYPE_T_H
#define _INCLUDE_POINTTEMPLATEOWNERSPAWNGROUPTYPE_T_H
...
#endif // _INCLUDE_POINTTEMPLATEOWNERSPAWNGROUPTYPE_T_H
