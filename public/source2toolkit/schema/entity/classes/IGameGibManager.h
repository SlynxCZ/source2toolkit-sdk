...
#ifndef _INCLUDE_IGAMEGIBMANAGER_H
#define _INCLUDE_IGAMEGIBMANAGER_H
...
public:
    ...
    virtual int32_t& CurrentMaxPieces() = 0;
    virtual void CurrentMaxPiecesUpdated() = 0;
    virtual int32_t& MaxPieces() = 0;
