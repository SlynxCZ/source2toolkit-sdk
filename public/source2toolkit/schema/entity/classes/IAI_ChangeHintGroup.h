...
#ifndef _INCLUDE_IAI_CHANGEHINTGROUP_H
#define _INCLUDE_IAI_CHANGEHINTGROUP_H
...
public:
    ...
    virtual CUtlSymbolLarge& StrSearchName() = 0;
    virtual void StrSearchNameUpdated() = 0;
    virtual CUtlSymbolLarge& StrNewHintGroup() = 0;
