...
#ifndef _INCLUDE_CINFOPLAYERTERRORIST_H
#define _INCLUDE_CINFOPLAYERTERRORIST_H
...
public:
    ...
    {
        return CBaseEntity::GetHandle<CInfoPlayerTerrorist>();
    }
};

#endif // _INCLUDE_CINFOPLAYERTERRORIST_H
