...
#ifndef _INCLUDE_IFILTERENEMY_H
#define _INCLUDE_IFILTERENEMY_H
...
public:
    ...
    virtual float& OuterRadius() = 0;
    virtual void OuterRadiusUpdated() = 0;
    virtual int32_t& MaxSquadmatesPerEnemy() = 0;
