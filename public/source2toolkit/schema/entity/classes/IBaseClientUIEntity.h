...
#ifndef _INCLUDE_IBASECLIENTUIENTITY_H
#define _INCLUDE_IBASECLIENTUIENTITY_H
...
public:
    ...
    virtual CUtlSymbolLarge& DialogXMLName() = 0;
    virtual void DialogXMLNameUpdated() = 0;
    virtual CUtlSymbolLarge& PanelClassName() = 0;
