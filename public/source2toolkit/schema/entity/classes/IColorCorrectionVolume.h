...
#ifndef _INCLUDE_ICOLORCORRECTIONVOLUME_H
#define _INCLUDE_ICOLORCORRECTIONVOLUME_H
...
public:
    ...
    virtual char* LookupFilename() = 0;
    virtual float& LastEnterWeight() = 0;
    virtual void LastEnterWeightUpdated() = 0;
    virtual float& LastEnterTime() = 0;
    virtual void LastEnterTimeUpdated() = 0;
    virtual float& LastExitWeight() = 0;
