...
#ifndef _INCLUDE_CSOUNDOPVARSETBOXENTITY_H
#define _INCLUDE_CSOUNDOPVARSETBOXENTITY_H
...
{
public:
    DECLARE_SCHEMA_CLASS(CSoundOpvarSetBoxEntity);
    ...
    SCHEMA_FIELD(int32_t, m_nBoxDirection);
...
public:
    static CSoundOpvarSetBoxEntity* New(const char* className)
    {
        return CBaseEntity::New<CSoundOpvarSetBoxEntity>(className);
    }

    static CSoundOpvarSetBoxEntity* FromIndex(int iIndex)
    {
        return CBaseEntity::FromIndex<CSoundOpvarSetBoxEntity>(iIndex);
    }

    static CSoundOpvarSetBoxEntity* FromIndex(CEntityIndex index)
    {
