...
#ifndef _INCLUDE_IBASEMODELENTITY__ONDAMAGELEVELCHANGEDARGS_T_H
#define _INCLUDE_IBASEMODELENTITY__ONDAMAGELEVELCHANGEDARGS_T_H
...
public:
    ...
    virtual int32_t& DamageLevelsRemaining() = 0;
