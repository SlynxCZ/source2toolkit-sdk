...
#ifndef _INCLUDE_IINFOWORLDLAYER_H
#define _INCLUDE_IINFOWORLDLAYER_H
...
public:
    ...
    virtual CUtlSymbolLarge& LayerName() = 0;
    virtual void LayerNameUpdated() = 0;
    virtual bool& WorldLayerVisible() = 0;
    virtual void WorldLayerVisibleUpdated() = 0;
    virtual bool& EntitiesSpawned() = 0;
    virtual void EntitiesSpawnedUpdated() = 0;
    virtual bool& CreateAsChildSpawnGroup() = 0;
