...
#ifndef _INCLUDE_IPOINTTEMPLATE_H
#define _INCLUDE_IPOINTTEMPLATE_H
...
public:
    ...
    virtual CUtlSymbolLarge& Source2EntityLumpName() = 0;
    virtual void Source2EntityLumpNameUpdated() = 0;
    virtual CUtlSymbolLarge& EntityFilterName() = 0;
    virtual void EntityFilterNameUpdated() = 0;
