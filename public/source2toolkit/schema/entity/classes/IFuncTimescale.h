...
#ifndef _INCLUDE_IFUNCTIMESCALE_H
#define _INCLUDE_IFUNCTIMESCALE_H
...
public:
    ...
    virtual void AccelerationUpdated() = 0;
    virtual float& MinBlendRate() = 0;
    virtual void MinBlendRateUpdated() = 0;
    virtual float& BlendDeltaMultiplier() = 0;
