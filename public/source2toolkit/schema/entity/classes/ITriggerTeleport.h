...
#ifndef _INCLUDE_ITRIGGERTELEPORT_H
#define _INCLUDE_ITRIGGERTELEPORT_H
...
public:
    ...
    virtual bool& UseLandmarkAngles() = 0;
    virtual void UseLandmarkAnglesUpdated() = 0;
    virtual bool& MirrorPlayer() = 0;
