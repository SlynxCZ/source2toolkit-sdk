...
#ifndef _INCLUDE_IPOINTTELEPORT_H
#define _INCLUDE_IPOINTTELEPORT_H
...
public:
    ...
    virtual QAngle& SaveAngles() = 0;
    virtual void SaveAnglesUpdated() = 0;
    virtual bool& TeleportParentedEntities() = 0;
