...
#ifndef _INCLUDE_ISOUNDOPVARSETPATHCORNERENTITY_H
#define _INCLUDE_ISOUNDOPVARSETPATHCORNERENTITY_H
...
public:
    ...
    virtual float& DistMinSqr() = 0;
    virtual void DistMinSqrUpdated() = 0;
