...
#ifndef _INCLUDE_ICSGO_ENDOFMATCHLINEUPSTART_H
#define _INCLUDE_ICSGO_ENDOFMATCHLINEUPSTART_H
...
public:
    ...
    static ICSGO_EndOfMatchLineupStart* FromRaw(CEntityInstance* p);
};
