...
#ifndef _INCLUDE_ISOUNDOPVARSETAUTOROOMENTITY_H
#define _INCLUDE_ISOUNDOPVARSETAUTOROOMENTITY_H
...
public:
    ...
    virtual CUtlVector<AutoRoomDoorwayPairs_t>& DoorwayPairs() = 0;
    virtual void DoorwayPairsUpdated() = 0;
    virtual float& Size() = 0;
    virtual void SizeUpdated() = 0;
    virtual float& HeightTolerance() = 0;
