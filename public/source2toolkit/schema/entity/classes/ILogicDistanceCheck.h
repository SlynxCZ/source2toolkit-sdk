...
#ifndef _INCLUDE_ILOGICDISTANCECHECK_H
#define _INCLUDE_ILOGICDISTANCECHECK_H
...
public:
    ...
    virtual CUtlSymbolLarge& EntityB() = 0;
    virtual void EntityBUpdated() = 0;
    virtual float& Zone1Distance() = 0;
