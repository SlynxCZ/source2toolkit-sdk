...
#ifndef _INCLUDE_CINFOINSTRUCTORHINTBOMBTARGETA_H
#define _INCLUDE_CINFOINSTRUCTORHINTBOMBTARGETA_H
...
public:
    ...
    {
        return CBaseEntity::GetHandle<CInfoInstructorHintBombTargetA>();
    }
};
