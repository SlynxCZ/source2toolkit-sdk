...
#ifndef _INCLUDE_IPLAYERVISIBILITY_H
#define _INCLUDE_IPLAYERVISIBILITY_H
...
public:
    ...
    virtual float& FogDistanceMultiplier() = 0;
    virtual void FogDistanceMultiplierUpdated() = 0;
    virtual float& FogMaxDensityMultiplier() = 0;
    virtual void FogMaxDensityMultiplierUpdated() = 0;
