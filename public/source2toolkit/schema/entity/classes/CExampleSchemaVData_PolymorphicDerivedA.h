...
#ifndef _INCLUDE_CEXAMPLESCHEMAVDATA_POLYMORPHICDERIVEDA_H
#define _INCLUDE_CEXAMPLESCHEMAVDATA_POLYMORPHICDERIVEDA_H
...
{
public:
    DECLARE_SCHEMA_CLASS_INLINE(CExampleSchemaVData_PolymorphicDerivedA);
