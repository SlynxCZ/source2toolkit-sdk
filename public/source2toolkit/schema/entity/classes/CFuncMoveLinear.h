...
#ifndef _INCLUDE_CFUNCMOVELINEAR_H
#define _INCLUDE_CFUNCMOVELINEAR_H
...
public:
    ...
    SCHEMA_FIELD(CGameSoundEventName, m_soundStart);
    SCHEMA_FIELD(CGameSoundEventName, m_soundStop);
