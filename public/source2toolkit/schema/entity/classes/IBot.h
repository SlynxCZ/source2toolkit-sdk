...
#ifndef _INCLUDE_IBOT_H
#define _INCLUDE_IBOT_H
...
public:
    ...
    virtual CCSPlayerPawn*& Player() = 0;
    virtual void PlayerUpdated() = 0;
    virtual bool& HasSpawned() = 0;
    virtual void HasSpawnedUpdated() = 0;
    ...
    virtual float& ForwardSpeed() = 0;
    virtual void ForwardSpeedUpdated() = 0;
    virtual float& LeftSpeed() = 0;
    virtual void LeftSpeedUpdated() = 0;
    virtual float& VerticalSpeed() = 0;
    virtual void VerticalSpeedUpdated() = 0;
    virtual uint64_t& ButtonFlags() = 0;
    virtual void ButtonFlagsUpdated() = 0;
    virtual float& JumpTimestamp() = 0;
    virtual void JumpTimestampUpdated() = 0;
    virtual Vector& ViewForward() = 0;
