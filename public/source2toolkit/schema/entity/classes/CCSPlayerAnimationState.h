...
#ifndef _INCLUDE_CCSPLAYERANIMATIONSTATE_H
#define _INCLUDE_CCSPLAYERANIMATIONSTATE_H
...
public:
    ...
    SCHEMA_FIELD(CCSPlayerAnimationState__Direction_t, m_groundActionDirection);
    SCHEMA_FIELD(CCSPlayerAnimationState__AirAction_t, m_airAction);
    SCHEMA_FIELD(bool, m_bWasOnGroundLastUpdate);
    SCHEMA_FIELD(bool, m_bWasStationaryLastUpdate);
    SCHEMA_FIELD(int32_t, m_actionStartTick);
    SCHEMA_FIELD(int32_t, m_staticAimTimerStartTick);
    SCHEMA_FIELD(int32_t, m_plantAndTurnStartTick);
    SCHEMA_FIELD(float, m_flTurnOnSpotAngle);
    SCHEMA_FIELD(float, m_flPreviousAimYaw);
    SCHEMA_FIELD(float, m_flPreviousHorizontalSpeed);
    SCHEMA_FIELD(float, m_flFootIKOffsetLeft);
