...
#ifndef _INCLUDE_ISOUNDOPVARSETPOINTBASE_H
#define _INCLUDE_ISOUNDOPVARSETPOINTBASE_H
...
public:
    ...
    virtual Vector& LastPosition() = 0;
    virtual void LastPositionUpdated() = 0;
    virtual float& RefreshTime() = 0;
    virtual void RefreshTimeUpdated() = 0;
    ...
    virtual int32_t& OpvarIndex() = 0;
    virtual void OpvarIndexUpdated() = 0;
    virtual bool& UseAutoCompare() = 0;
