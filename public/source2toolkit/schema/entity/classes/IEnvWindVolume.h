...
#ifndef _INCLUDE_IENVWINDVOLUME_H
#define _INCLUDE_IENVWINDVOLUME_H
...
public:
    ...
    virtual int32_t& Shape() = 0;
    virtual void ShapeUpdated() = 0;
    virtual float& WindSpeedMultiplier() = 0;
    virtual void WindSpeedMultiplierUpdated() = 0;
    virtual float& WindTurbulenceMultiplier() = 0;
    virtual void WindTurbulenceMultiplierUpdated() = 0;
    virtual float& WindSpeedVariationMultiplier() = 0;
