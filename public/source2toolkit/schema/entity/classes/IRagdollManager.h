...
#ifndef _INCLUDE_IRAGDOLLMANAGER_H
#define _INCLUDE_IRAGDOLLMANAGER_H
...
public:
    ...
    virtual int32_t& MaxRagdollCount() = 0;
    virtual void MaxRagdollCountUpdated() = 0;
    virtual bool& SaveImportant() = 0;
