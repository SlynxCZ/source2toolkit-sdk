...
#ifndef _INCLUDE_CDYNAMICPROPALIAS_DYNAMIC_PROP_H
#define _INCLUDE_CDYNAMICPROPALIAS_DYNAMIC_PROP_H
...
public:
    ...
    {
        return CBaseEntity::GetHandle<CDynamicPropAlias_dynamic_prop>();
    }
};
