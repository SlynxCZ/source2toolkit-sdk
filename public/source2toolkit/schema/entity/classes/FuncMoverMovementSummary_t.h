...
#ifndef _INCLUDE_FUNCMOVERMOVEMENTSUMMARY_T_H
#define _INCLUDE_FUNCMOVERMOVEMENTSUMMARY_T_H
...
public:
    ...
    SCHEMA_FIELD(int32_t, nStartNodeIndex);
    SCHEMA_FIELD(int32_t, nStopNodeIndex);
    SCHEMA_FIELD(int32_t, nMovementMode);
