...
#ifndef _INCLUDE_ILOGICRELAY_H
#define _INCLUDE_ILOGICRELAY_H
...
public:
    ...
    virtual bool& WaitForRefire() = 0;
    virtual void WaitForRefireUpdated() = 0;
    virtual bool& TriggerOnce() = 0;
    virtual void TriggerOnceUpdated() = 0;
    virtual bool& FastRetrigger() = 0;
