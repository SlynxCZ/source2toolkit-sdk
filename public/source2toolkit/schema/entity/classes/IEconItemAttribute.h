...
#ifndef _INCLUDE_IECONITEMATTRIBUTE_H
#define _INCLUDE_IECONITEMATTRIBUTE_H
...
public:
    ...
    virtual float& InitialValue() = 0;
    virtual void InitialValueUpdated() = 0;
    virtual int32_t& RefundableCurrency() = 0;
