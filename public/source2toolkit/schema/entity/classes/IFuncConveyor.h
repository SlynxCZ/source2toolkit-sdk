...
#ifndef _INCLUDE_IFUNCCONVEYOR_H
#define _INCLUDE_IFUNCCONVEYOR_H
...
public:
    ...
    virtual float& TransitionDurationSeconds() = 0;
    virtual void TransitionDurationSecondsUpdated() = 0;
    virtual QAngle& MoveEntitySpace() = 0;
    virtual void MoveEntitySpaceUpdated() = 0;
    virtual Vector& MoveDirEntitySpace() = 0;
    virtual void MoveDirEntitySpaceUpdated() = 0;
    virtual float& TargetSpeed() = 0;
    virtual void TargetSpeedUpdated() = 0;
    virtual int32_t& TransitionStartTick() = 0;
    virtual void TransitionStartTickUpdated() = 0;
    virtual int32_t& TransitionDurationTicks() = 0;
