...
#ifndef _INCLUDE_CINFOCHOREOANCHORPOSITION_H
#define _INCLUDE_CINFOCHOREOANCHORPOSITION_H
...
public:
    ...
    SCHEMA_FIELD(Vector, m_vExtentsMin);
    SCHEMA_FIELD(Vector, m_vExtentsMax);
    SCHEMA_FIELD(float, m_flRadius);
    SCHEMA_FIELD(bool, m_bOnlyWarpPosition);
    SCHEMA_FIELD(CHandle<CBaseEntity>, m_hParent);
