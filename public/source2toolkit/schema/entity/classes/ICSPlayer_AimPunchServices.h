...
#ifndef _INCLUDE_ICSPLAYER_AIMPUNCHSERVICES_H
#define _INCLUDE_ICSPLAYER_AIMPUNCHSERVICES_H
...
public:
    ...
    virtual float& PredictableBaseTickInterpAmount() = 0;
    virtual void PredictableBaseTickInterpAmountUpdated() = 0;
    virtual QAngle& PredictableBaseAngle() = 0;
    virtual void PredictableBaseAngleUpdated() = 0;
    virtual QAngle& PredictableBaseAngleVel() = 0;
    virtual void PredictableBaseAngleVelUpdated() = 0;
    virtual int32_t& UnpredictableBaseTick() = 0;
