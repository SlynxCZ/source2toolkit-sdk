...
#ifndef _INCLUDE_IFUNCTRACKCHANGE_H
#define _INCLUDE_IFUNCTRACKCHANGE_H
...
class IFuncTrackChange : public virtual IFuncPlatRot
{
public:
    ...
    virtual CHandle<CPathTrack>& TrackBottom() = 0;
    virtual void TrackBottomUpdated() = 0;
    virtual CHandle<CFuncTrackTrain>& Train() = 0;
    virtual void TrainUpdated() = 0;
    virtual CUtlSymbolLarge& TrackTopName() = 0;
    virtual void TrackTopNameUpdated() = 0;
    virtual CUtlSymbolLarge& TrackBottomName() = 0;
