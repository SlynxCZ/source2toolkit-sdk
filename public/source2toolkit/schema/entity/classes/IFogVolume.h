...
#ifndef _INCLUDE_IFOGVOLUME_H
#define _INCLUDE_IFOGVOLUME_H
...
public:
    ...
    virtual CUtlSymbolLarge& PostProcessName() = 0;
    virtual void PostProcessNameUpdated() = 0;
    virtual CUtlSymbolLarge& ColorCorrectionName() = 0;
    virtual void ColorCorrectionNameUpdated() = 0;
