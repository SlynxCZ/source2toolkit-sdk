...
#ifndef _INCLUDE_IDYNAMICNAVCONNECTIONSVOLUME_H
#define _INCLUDE_IDYNAMICNAVCONNECTIONSVOLUME_H
...
public:
    ...
    virtual CUtlVector<DynamicVolumeDef_t>& Connections() = 0;
    virtual void ConnectionsUpdated() = 0;
    virtual CGlobalSymbol& TransitionType() = 0;
    virtual void TransitionTypeUpdated() = 0;
    virtual bool& ConnectionsEnabled() = 0;
    virtual void ConnectionsEnabledUpdated() = 0;
    virtual float& TargetAreaSearchRadius() = 0;
    virtual void TargetAreaSearchRadiusUpdated() = 0;
    virtual float& UpdateDistance() = 0;
