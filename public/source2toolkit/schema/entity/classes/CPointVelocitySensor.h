...
#ifndef _INCLUDE_CPOINTVELOCITYSENSOR_H
#define _INCLUDE_CPOINTVELOCITYSENSOR_H
...
public:
    ...
    CHandle<CPointVelocitySensor> GetHandle()
    {
        return CBaseEntity::GetHandle<CPointVelocitySensor>();
    }
};
