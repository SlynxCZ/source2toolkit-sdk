...
#ifndef _INCLUDE_CCSGO_WINGMANINTROCHARACTERPOSITION_H
#define _INCLUDE_CCSGO_WINGMANINTROCHARACTERPOSITION_H
...
public:
    ...
    {
        return CBaseEntity::GetHandle<CCSGO_WingmanIntroCharacterPosition>();
    }
};
