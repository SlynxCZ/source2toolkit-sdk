...
#ifndef _INCLUDE_CHOSTAGERESCUEZONESHIM_H
#define _INCLUDE_CHOSTAGERESCUEZONESHIM_H
...
public:
    ...
    CHandle<CHostageRescueZoneShim> GetHandle()
    {
        return CBaseEntity::GetHandle<CHostageRescueZoneShim>();
    }
};
