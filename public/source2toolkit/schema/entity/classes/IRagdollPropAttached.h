...
#ifndef _INCLUDE_IRAGDOLLPROPATTACHED_H
#define _INCLUDE_IRAGDOLLPROPATTACHED_H
...
public:
    ...
    virtual uint32_t& RagdollAttachedObjectIndex() = 0;
    virtual void RagdollAttachedObjectIndexUpdated() = 0;
    virtual Vector& AttachmentPointBoneSpace() = 0;
    virtual void AttachmentPointBoneSpaceUpdated() = 0;
    virtual Vector& AttachmentPointRagdollSpace() = 0;
    virtual void AttachmentPointRagdollSpaceUpdated() = 0;
