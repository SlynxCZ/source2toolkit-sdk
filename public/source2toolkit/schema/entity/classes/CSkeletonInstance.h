...
#ifndef _INCLUDE_CSKELETONINSTANCE_H
#define _INCLUDE_CSKELETONINSTANCE_H
...
public:
    ...
    SCHEMA_FIELD(bool, m_bDirtyMotionType);
    SCHEMA_FIELD(bool, m_bIsGeneratingLatchedParentSpaceState);
