...
#ifndef _INCLUDE_IPOINTBROADCASTCLIENTCOMMAND_H
#define _INCLUDE_IPOINTBROADCASTCLIENTCOMMAND_H
...
class IPointBroadcastClientCommand : public virtual IPointEntity
{
public:
