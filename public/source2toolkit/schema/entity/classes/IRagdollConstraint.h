...
#ifndef _INCLUDE_IRAGDOLLCONSTRAINT_H
#define _INCLUDE_IRAGDOLLCONSTRAINT_H
...
public:
    ...
    virtual void XmaxUpdated() = 0;
    virtual float& Ymin() = 0;
    virtual void YminUpdated() = 0;
    virtual float& Ymax() = 0;
    virtual void YmaxUpdated() = 0;
    virtual float& Zmin() = 0;
    virtual void ZminUpdated() = 0;
    virtual float& Zmax() = 0;
    virtual void ZmaxUpdated() = 0;
    virtual float& Xfriction() = 0;
    virtual void XfrictionUpdated() = 0;
    virtual float& Yfriction() = 0;
