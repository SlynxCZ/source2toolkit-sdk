...
#ifndef _INCLUDE_CLOGICEVENTLISTENER_H
#define _INCLUDE_CLOGICEVENTLISTENER_H
...
public:
    ...
    CHandle<CLogicEventListener> GetHandle()
    {
        return CBaseEntity::GetHandle<CLogicEventListener>();
    }
};
