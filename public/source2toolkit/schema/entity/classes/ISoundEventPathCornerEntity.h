...
#ifndef _INCLUDE_ISOUNDEVENTPATHCORNERENTITY_H
#define _INCLUDE_ISOUNDEVENTPATHCORNERENTITY_H
...
public:
    ...
    virtual int32_t& CountMax() = 0;
    virtual void CountMaxUpdated() = 0;
    virtual float& DistanceMax() = 0;
    virtual void DistanceMaxUpdated() = 0;
    virtual float& DistMaxSqr() = 0;
    virtual void DistMaxSqrUpdated() = 0;
    virtual float& DotProductMax() = 0;
