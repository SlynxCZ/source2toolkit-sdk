...
#ifndef _INCLUDE_IINFODYNAMICSHADOWHINT_H
#define _INCLUDE_IINFODYNAMICSHADOWHINT_H
...
public:
    ...
    virtual int32_t& Importance() = 0;
    virtual void ImportanceUpdated() = 0;
    virtual int32_t& LightChoice() = 0;
