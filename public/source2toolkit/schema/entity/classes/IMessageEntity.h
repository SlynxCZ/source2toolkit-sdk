...
#ifndef _INCLUDE_IMESSAGEENTITY_H
#define _INCLUDE_IMESSAGEENTITY_H
...
public:
    ...
    virtual CUtlSymbolLarge& MessageText() = 0;
    virtual void MessageTextUpdated() = 0;
    virtual bool& DrawText() = 0;
    virtual void DrawTextUpdated() = 0;
    virtual bool& DeveloperOnly() = 0;
