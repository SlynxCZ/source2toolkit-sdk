...
#ifndef _INCLUDE_IPHYSICSENTITYSOLVER_H
#define _INCLUDE_IPHYSICSENTITYSOLVER_H
...
public:
    ...
    virtual CHandle<CBaseEntity>& PhysicsBlocker() = 0;
    virtual void PhysicsBlockerUpdated() = 0;
    virtual float& SeparationDuration() = 0;
