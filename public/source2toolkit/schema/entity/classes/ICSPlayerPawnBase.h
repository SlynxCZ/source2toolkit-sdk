...
#ifndef _INCLUDE_ICSPLAYERPAWNBASE_H
#define _INCLUDE_ICSPLAYERPAWNBASE_H
...
public:
    ...
    virtual bool& HasMovedSinceSpawn() = 0;
    virtual void HasMovedSinceSpawnUpdated() = 0;
    virtual int32_t& NumSpawns() = 0;
    virtual void NumSpawnsUpdated() = 0;
    virtual float& IdleTimeSinceLastAction() = 0;
    virtual void IdleTimeSinceLastActionUpdated() = 0;
    virtual float& NextRadarUpdateTime() = 0;
    virtual void NextRadarUpdateTimeUpdated() = 0;
    virtual float& FlashDuration() = 0;
    virtual void FlashDurationUpdated() = 0;
    virtual float& FlashMaxAlpha() = 0;
    virtual void FlashMaxAlphaUpdated() = 0;
    virtual float& ProgressBarStartTime() = 0;
    virtual void ProgressBarStartTimeUpdated() = 0;
    virtual int32_t& ProgressBarDuration() = 0;
