...
#ifndef _INCLUDE_IATTRIBUTEMANAGER__CACHED_ATTRIBUTE_FLOAT_T_H
#define _INCLUDE_IATTRIBUTEMANAGER__CACHED_ATTRIBUTE_FLOAT_T_H
...
public:
    ...
    virtual CUtlSymbolLarge& AttribHook() = 0;
