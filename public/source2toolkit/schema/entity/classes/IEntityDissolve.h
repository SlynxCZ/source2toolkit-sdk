...
#ifndef _INCLUDE_IENTITYDISSOLVE_H
#define _INCLUDE_IENTITYDISSOLVE_H
...
public:
    ...
    virtual float& FadeInLength() = 0;
    virtual void FadeInLengthUpdated() = 0;
    virtual float& FadeOutModelStart() = 0;
    virtual void FadeOutModelStartUpdated() = 0;
    virtual float& FadeOutModelLength() = 0;
    virtual void FadeOutModelLengthUpdated() = 0;
    virtual float& FadeOutStart() = 0;
    virtual void FadeOutStartUpdated() = 0;
    virtual float& FadeOutLength() = 0;
