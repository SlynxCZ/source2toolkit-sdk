...
#ifndef _INCLUDE_CCSGO_TEAMSELECTTERRORISTPOSITION_H
#define _INCLUDE_CCSGO_TEAMSELECTTERRORISTPOSITION_H
...
public:
    ...
    {
        return CBaseEntity::GetHandle<CCSGO_TeamSelectTerroristPosition>();
    }
};
