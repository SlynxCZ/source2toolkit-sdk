...
#ifndef _INCLUDE_CPRECIPITATIONBLOCKER_H
#define _INCLUDE_CPRECIPITATIONBLOCKER_H
...
public:
    ...
    CHandle<CPrecipitationBlocker> GetHandle()
    {
        return CBaseEntity::GetHandle<CPrecipitationBlocker>();
    }
};
