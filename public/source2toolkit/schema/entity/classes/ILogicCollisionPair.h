...
#ifndef _INCLUDE_ILOGICCOLLISIONPAIR_H
#define _INCLUDE_ILOGICCOLLISIONPAIR_H
...
public:
    ...
    virtual bool& IncludeHierarchy() = 0;
    virtual void IncludeHierarchyUpdated() = 0;
    virtual bool& SupportMultipleEntitiesWithSameName() = 0;
    virtual void SupportMultipleEntitiesWithSameNameUpdated() = 0;
