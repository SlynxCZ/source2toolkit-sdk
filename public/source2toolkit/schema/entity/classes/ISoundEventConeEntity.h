...
#ifndef _INCLUDE_ISOUNDEVENTCONEENTITY_H
#define _INCLUDE_ISOUNDEVENTCONEENTITY_H
...
public:
    ...
    virtual float& SweetSpotAngle() = 0;
    virtual void SweetSpotAngleUpdated() = 0;
    virtual float& AttenMin() = 0;
    virtual void AttenMinUpdated() = 0;
    virtual float& AttenMax() = 0;
