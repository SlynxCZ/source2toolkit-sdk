...
#ifndef _INCLUDE_CTRIGGERDETECTBULLETFIRE_H
#define _INCLUDE_CTRIGGERDETECTBULLETFIRE_H
...
public:
    ...
    CHandle<CTriggerDetectBulletFire> GetHandle()
    {
        return CBaseEntity::GetHandle<CTriggerDetectBulletFire>();
    }
};
