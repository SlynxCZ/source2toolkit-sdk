...
#ifndef _INCLUDE_ISKELETONINSTANCE_H
#define _INCLUDE_ISKELETONINSTANCE_H
...
public:
    ...
    virtual bool& DisableSolidCollisionsForHierarchy() = 0;
    virtual void DisableSolidCollisionsForHierarchyUpdated() = 0;
    virtual CUtlStringToken* MaterialGroup() = 0;
    virtual uint8_t& HitboxSet() = 0;
