...
#ifndef _INCLUDE_CCHOREOCOMPONENT_H
#define _INCLUDE_CCHOREOCOMPONENT_H
...
public:
    ...
    SCHEMA_FIELD(int32_t, m_nExernalChoreoGraphCount);
    SCHEMA_FIELD(CGlobalSymbol, m_sActiveExternalChoreoGraphSlotID);
