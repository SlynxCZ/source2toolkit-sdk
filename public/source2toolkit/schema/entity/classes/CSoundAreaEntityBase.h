...
#ifndef _INCLUDE_CSOUNDAREAENTITYBASE_H
#define _INCLUDE_CSOUNDAREAENTITYBASE_H
...
public:
    ...
    CHandle<CSoundAreaEntityBase> GetHandle()
    {
        return CBaseEntity::GetHandle<CSoundAreaEntityBase>();
    }
};
