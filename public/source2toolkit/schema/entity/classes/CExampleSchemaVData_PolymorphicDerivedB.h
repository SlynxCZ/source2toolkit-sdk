...
#ifndef _INCLUDE_CEXAMPLESCHEMAVDATA_POLYMORPHICDERIVEDB_H
#define _INCLUDE_CEXAMPLESCHEMAVDATA_POLYMORPHICDERIVEDB_H
...
{
public:
    DECLARE_SCHEMA_CLASS_INLINE(CExampleSchemaVData_PolymorphicDerivedB);
