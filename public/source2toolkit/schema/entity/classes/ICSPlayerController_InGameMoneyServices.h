...
#ifndef _INCLUDE_ICSPLAYERCONTROLLER_INGAMEMONEYSERVICES_H
#define _INCLUDE_ICSPLAYERCONTROLLER_INGAMEMONEYSERVICES_H
...
public:
    ...
    virtual int32_t& MoneyEarnedForNextRound() = 0;
    virtual void MoneyEarnedForNextRoundUpdated() = 0;
    virtual int32_t& Account() = 0;
    virtual void AccountUpdated() = 0;
    virtual int32_t& StartAccount() = 0;
    virtual void StartAccountUpdated() = 0;
    virtual int32_t& TotalCashSpent() = 0;
