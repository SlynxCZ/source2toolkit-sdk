...
#ifndef _INCLUDE_CCSGO_WINGMANINTROCOUNTERTERRORISTPOSITION_H
#define _INCLUDE_CCSGO_WINGMANINTROCOUNTERTERRORISTPOSITION_H
...
public:
    ...
    {
        return CBaseEntity::GetHandle<CCSGO_WingmanIntroCounterTerroristPosition>();
    }
};
