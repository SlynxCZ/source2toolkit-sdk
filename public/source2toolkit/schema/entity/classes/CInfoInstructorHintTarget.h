...
#ifndef _INCLUDE_CINFOINSTRUCTORHINTTARGET_H
#define _INCLUDE_CINFOINSTRUCTORHINTTARGET_H
...
public:
    ...
    CHandle<CInfoInstructorHintTarget> GetHandle()
    {
        return CBaseEntity::GetHandle<CInfoInstructorHintTarget>();
    }
};
