...
#ifndef _INCLUDE_ILOGICMEASUREMOVEMENT_H
#define _INCLUDE_ILOGICMEASUREMOVEMENT_H
...
public:
    ...
    virtual CUtlSymbolLarge& StrMeasureReference() = 0;
    virtual void StrMeasureReferenceUpdated() = 0;
    virtual CUtlSymbolLarge& StrTargetReference() = 0;
    virtual void StrTargetReferenceUpdated() = 0;
    virtual CHandle<CBaseEntity>& MeasureTarget() = 0;
    virtual void MeasureTargetUpdated() = 0;
    virtual CHandle<CBaseEntity>& MeasureReference() = 0;
    virtual void MeasureReferenceUpdated() = 0;
    virtual CHandle<CBaseEntity>& Target() = 0;
    virtual void TargetUpdated() = 0;
    virtual CHandle<CBaseEntity>& TargetReference() = 0;
    virtual void TargetReferenceUpdated() = 0;
