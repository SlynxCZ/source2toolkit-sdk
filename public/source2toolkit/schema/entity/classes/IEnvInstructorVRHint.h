...
#ifndef _INCLUDE_IENVINSTRUCTORVRHINT_H
#define _INCLUDE_IENVINSTRUCTORVRHINT_H
...
public:
    ...
    virtual CUtlSymbolLarge& StartSound() = 0;
    virtual void StartSoundUpdated() = 0;
    virtual int32_t& LayoutFileType() = 0;
    virtual void LayoutFileTypeUpdated() = 0;
    virtual CUtlSymbolLarge& CustomLayoutFile() = 0;
    virtual void CustomLayoutFileUpdated() = 0;
    virtual int32_t& AttachType() = 0;
