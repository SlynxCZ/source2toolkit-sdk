...
#ifndef _INCLUDE_ICSOBSERVER_MOVEMENTSERVICES_H
#define _INCLUDE_ICSOBSERVER_MOVEMENTSERVICES_H
...
class ICSObserver_MovementServices : public virtual IPlayer_MovementServices
{
public:
