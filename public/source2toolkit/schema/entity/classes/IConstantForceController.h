...
#ifndef _INCLUDE_ICONSTANTFORCECONTROLLER_H
#define _INCLUDE_ICONSTANTFORCECONTROLLER_H
...
public:
    ...
    virtual RotationVector& Angular() = 0;
    virtual void AngularUpdated() = 0;
    virtual Vector& LinearSave() = 0;
