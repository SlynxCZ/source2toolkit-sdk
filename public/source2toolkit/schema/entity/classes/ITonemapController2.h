...
#ifndef _INCLUDE_ITONEMAPCONTROLLER2_H
#define _INCLUDE_ITONEMAPCONTROLLER2_H
...
public:
    ...
    virtual float& AutoExposureMax() = 0;
    virtual void AutoExposureMaxUpdated() = 0;
    virtual float& ExposureAdaptationSpeedUp() = 0;
    virtual void ExposureAdaptationSpeedUpUpdated() = 0;
    virtual float& ExposureAdaptationSpeedDown() = 0;
