...
#ifndef _INCLUDE_CSOUNDOPVARSETENTITY_H
#define _INCLUDE_CSOUNDOPVARSETENTITY_H
...
public:
    ...
    CHandle<CSoundOpvarSetEntity> GetHandle()
    {
        return CBaseEntity::GetHandle<CSoundOpvarSetEntity>();
    }
};
