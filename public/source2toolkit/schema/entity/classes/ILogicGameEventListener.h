...
#ifndef _INCLUDE_ILOGICGAMEEVENTLISTENER_H
#define _INCLUDE_ILOGICGAMEEVENTLISTENER_H
...
class ILogicGameEventListener : public virtual ILogicalEntity
{
public:
    ...
    virtual CUtlSymbolLarge& GameEventName() = 0;
    virtual void GameEventNameUpdated() = 0;
    virtual CUtlSymbolLarge& GameEventItem() = 0;
    virtual void GameEventItemUpdated() = 0;
