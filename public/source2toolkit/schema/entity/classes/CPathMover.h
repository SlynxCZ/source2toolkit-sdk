...
#ifndef _INCLUDE_CPATHMOVER_H
#define _INCLUDE_CPATHMOVER_H
...
public:
    ...
    SCHEMA_FIELD(CUtlVector<CHandle<CPathMoverEntitySpawner>>, m_vecSpawners);
    SCHEMA_FIELD(CUtlSymbolLarge, m_iszMoverSpawnerName);
    SCHEMA_FIELD(CHandle<CFuncMoverRouter>, m_hMoverRouter);
    SCHEMA_FIELD(CUtlSymbolLarge, m_iszMoverRouterName);
    SCHEMA_FIELD(float, m_flSampleSpacing);
