...
#ifndef _INCLUDE_IRETAKEGAMERULES_H
#define _INCLUDE_IRETAKEGAMERULES_H
...
public:
    ...
    virtual bool& BlockersPresent() = 0;
    virtual void BlockersPresentUpdated() = 0;
    virtual bool& RoundInProgress() = 0;
    virtual void RoundInProgressUpdated() = 0;
    virtual int32_t& FirstSecondHalfRound() = 0;
    virtual void FirstSecondHalfRoundUpdated() = 0;
