...
#ifndef _INCLUDE_CSERVERONLYENTITY_H
#define _INCLUDE_CSERVERONLYENTITY_H
...
public:
    ...
    CHandle<CServerOnlyEntity> GetHandle()
    {
        return CBaseEntity::GetHandle<CServerOnlyEntity>();
    }
};

#endif // _INCLUDE_CSERVERONLYENTITY_H
