...
#ifndef _INCLUDE_CENVSOUNDSCAPEPROXY_H
#define _INCLUDE_CENVSOUNDSCAPEPROXY_H
...
public:
    ...
    CHandle<CEnvSoundscapeProxy> GetHandle()
    {
        return CBaseEntity::GetHandle<CEnvSoundscapeProxy>();
    }
};
