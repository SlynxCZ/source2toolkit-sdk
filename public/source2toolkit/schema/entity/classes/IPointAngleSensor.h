...
#ifndef _INCLUDE_IPOINTANGLESENSOR_H
#define _INCLUDE_IPOINTANGLESENSOR_H
...
public:
    ...
    virtual CUtlSymbolLarge& LookAtName() = 0;
    virtual void LookAtNameUpdated() = 0;
    virtual CHandle<CBaseEntity>& TargetEntity() = 0;
    virtual void TargetEntityUpdated() = 0;
    virtual CHandle<CBaseEntity>& LookAtEntity() = 0;
    virtual void LookAtEntityUpdated() = 0;
    virtual float& Duration() = 0;
    virtual void DurationUpdated() = 0;
    virtual float& DotTolerance() = 0;
    virtual void DotToleranceUpdated() = 0;
    virtual float& FacingTime() = 0;
