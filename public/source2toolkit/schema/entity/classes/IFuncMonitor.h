...
#ifndef _INCLUDE_IFUNCMONITOR_H
#define _INCLUDE_IFUNCMONITOR_H
...
public:
    ...
    virtual int32_t& ResolutionEnum() = 0;
    virtual void ResolutionEnumUpdated() = 0;
    virtual bool& RenderShadows() = 0;
    virtual void RenderShadowsUpdated() = 0;
    virtual bool& UseUniqueColorTarget() = 0;
