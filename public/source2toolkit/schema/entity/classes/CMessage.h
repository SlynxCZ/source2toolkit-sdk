...
#ifndef _INCLUDE_CMESSAGE_H
#define _INCLUDE_CMESSAGE_H
...
public:
    ...
    SCHEMA_FIELD(CGameSoundEventName, m_sNoise);
...
public:
    ...
    CHandle<CMessage> GetHandle()
    {
        return CBaseEntity::GetHandle<CMessage>();
    }
};
