...
#ifndef _INCLUDE_IINFOSPAWNGROUPLOADUNLOAD_H
#define _INCLUDE_IINFOSPAWNGROUPLOADUNLOAD_H
...
public:
    ...
    virtual CUtlSymbolLarge& SpawnGroupFilterName() = 0;
    virtual void SpawnGroupFilterNameUpdated() = 0;
    virtual CUtlSymbolLarge& LandmarkName() = 0;
    virtual void LandmarkNameUpdated() = 0;
    virtual CUtlString& FixedSpawnGroupName() = 0;
    virtual void FixedSpawnGroupNameUpdated() = 0;
    virtual float& TimeoutInterval() = 0;
    virtual void TimeoutIntervalUpdated() = 0;
    virtual bool& AutoActivate() = 0;
    virtual void AutoActivateUpdated() = 0;
    virtual bool& UnloadingStarted() = 0;
    virtual void UnloadingStartedUpdated() = 0;
    virtual bool& QueueActiveSpawnGroupChange() = 0;
