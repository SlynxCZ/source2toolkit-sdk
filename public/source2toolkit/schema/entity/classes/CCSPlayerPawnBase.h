...
#ifndef _INCLUDE_CCSPLAYERPAWNBASE_H
#define _INCLUDE_CCSPLAYERPAWNBASE_H
...
public:
    ...
    CHandle<CCSPlayerPawnBase> GetHandle()
    {
        return CBaseEntity::GetHandle<CCSPlayerPawnBase>();
    }
};
