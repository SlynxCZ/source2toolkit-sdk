...
#ifndef _INCLUDE_ILOGICDISTANCEAUTOSAVE_H
#define _INCLUDE_ILOGICDISTANCEAUTOSAVE_H
...
public:
    ...
    virtual float& DistanceToPlayer() = 0;
    virtual void DistanceToPlayerUpdated() = 0;
    virtual bool& ForceNewLevelUnit() = 0;
    virtual void ForceNewLevelUnitUpdated() = 0;
    virtual bool& CheckCough() = 0;
    virtual void CheckCoughUpdated() = 0;
    virtual bool& ThinkDangerous() = 0;
