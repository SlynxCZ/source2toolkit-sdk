...
#ifndef _INCLUDE_CDESTRUCTIBLEPARTSCOMPONENT_H
#define _INCLUDE_CDESTRUCTIBLEPARTSCOMPONENT_H
...
#include "CAnimGraphControllerPtr.h"
...
public:
    ...
    SCHEMA_FIELD(CAnimGraphControllerPtr, m_pAnimGraphDestructibleGraphController);
};
