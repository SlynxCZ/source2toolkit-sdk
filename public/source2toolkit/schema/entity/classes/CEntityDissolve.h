...
#ifndef _INCLUDE_CENTITYDISSOLVE_H
#define _INCLUDE_CENTITYDISSOLVE_H
...
#include "../enums/EntityDissolveType_t.h"
...
public:
    ...
    SCHEMA_FIELD(EntityDissolveType_t, m_nDissolveType);
