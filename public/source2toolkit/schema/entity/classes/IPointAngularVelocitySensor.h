...
#ifndef _INCLUDE_IPOINTANGULARVELOCITYSENSOR_H
#define _INCLUDE_IPOINTANGULARVELOCITYSENSOR_H
...
public:
    ...
    virtual void ThresholdUpdated() = 0;
    virtual int32_t& LastCompareResult() = 0;
    virtual void LastCompareResultUpdated() = 0;
    virtual int32_t& LastFireResult() = 0;
    virtual void LastFireResultUpdated() = 0;
    virtual float& FireTime() = 0;
    virtual void FireTimeUpdated() = 0;
    virtual float& FireInterval() = 0;
    virtual void FireIntervalUpdated() = 0;
    virtual float& LastAngVelocity() = 0;
    virtual void LastAngVelocityUpdated() = 0;
    virtual QAngle& LastOrientation() = 0;
    virtual void LastOrientationUpdated() = 0;
