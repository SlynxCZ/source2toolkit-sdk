...
#ifndef _INCLUDE_IINFOCHOREOANCHORPOSITION_H
#define _INCLUDE_IINFOCHOREOANCHORPOSITION_H
...
public:
    ...
    virtual QAngle& Angles() = 0;
    virtual void AnglesUpdated() = 0;
    virtual Vector& ExtentsMin() = 0;
    virtual void ExtentsMinUpdated() = 0;
    virtual Vector& ExtentsMax() = 0;
