...
#ifndef _INCLUDE_IINFOFAN_H
#define _INCLUDE_IINFOFAN_H
...
public:
    ...
    virtual float& FanForceMinRadius() = 0;
    virtual void FanForceMinRadiusUpdated() = 0;
    virtual float& CurveDistRange() = 0;
