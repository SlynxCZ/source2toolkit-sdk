...
#ifndef _INCLUDE_IDECOYPROJECTILE_H
#define _INCLUDE_IDECOYPROJECTILE_H
...
public:
    ...
    virtual int32_t& ShotsRemaining() = 0;
    virtual void ShotsRemainingUpdated() = 0;
    virtual float& ExpireTime() = 0;
