...
#ifndef _INCLUDE_CSHATTERGLASSSHARDPHYSICS_H
#define _INCLUDE_CSHATTERGLASSSHARDPHYSICS_H
...
#include "../enums/ShatterGlassEntityPoolState_t.h"
...
public:
    ...
    SCHEMA_FIELD(ShatterGlassEntityPoolState_t, m_nPoolState);
