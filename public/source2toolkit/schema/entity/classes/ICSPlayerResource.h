...
#ifndef _INCLUDE_ICSPLAYERRESOURCE_H
#define _INCLUDE_ICSPLAYERRESOURCE_H
...
public:
    ...
    virtual CEntityIndex* HostageEntityIDs() = 0;
    virtual Vector& BombsiteCenterA() = 0;
    virtual void BombsiteCenterAUpdated() = 0;
    virtual Vector& BombsiteCenterB() = 0;
    virtual void BombsiteCenterBUpdated() = 0;
    virtual int32_t* HostageRescueX() = 0;
    virtual int32_t* HostageRescueY() = 0;
    virtual int32_t* HostageRescueZ() = 0;
    virtual bool& EndMatchNextMapAllVoted() = 0;
