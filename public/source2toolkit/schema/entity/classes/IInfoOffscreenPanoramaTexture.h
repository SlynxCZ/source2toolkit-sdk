...
#ifndef _INCLUDE_IINFOOFFSCREENPANORAMATEXTURE_H
#define _INCLUDE_IINFOOFFSCREENPANORAMATEXTURE_H
...
public:
    ...
    virtual int32_t& ResolutionX() = 0;
    virtual void ResolutionXUpdated() = 0;
    virtual int32_t& ResolutionY() = 0;
    virtual void ResolutionYUpdated() = 0;
    virtual CUtlSymbolLarge& PanelType() = 0;
    virtual void PanelTypeUpdated() = 0;
    virtual CUtlSymbolLarge& LayoutFileName() = 0;
    virtual void LayoutFileNameUpdated() = 0;
    virtual CUtlSymbolLarge& RenderAttrName() = 0;
    virtual void RenderAttrNameUpdated() = 0;
    virtual CUtlVector<CHandle<CBaseModelEntity>>& TargetEntities() = 0;
