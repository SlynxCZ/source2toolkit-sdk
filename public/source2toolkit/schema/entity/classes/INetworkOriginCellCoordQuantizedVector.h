...
#ifndef _INCLUDE_INETWORKORIGINCELLCOORDQUANTIZEDVECTOR_H
#define _INCLUDE_INETWORKORIGINCELLCOORDQUANTIZEDVECTOR_H
...
public:
    ...
    virtual uint16_t& CellY() = 0;
    virtual void CellYUpdated() = 0;
    virtual uint16_t& CellZ() = 0;
    virtual void CellZUpdated() = 0;
    virtual uint16_t& OutsideWorld() = 0;
    virtual void OutsideWorldUpdated() = 0;
    virtual float& X() = 0;
