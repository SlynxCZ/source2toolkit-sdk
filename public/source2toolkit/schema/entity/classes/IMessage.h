...
#ifndef _INCLUDE_IMESSAGE_H
#define _INCLUDE_IMESSAGE_H
...
public:
    ...
    virtual float& MessageVolume() = 0;
    virtual void MessageVolumeUpdated() = 0;
    virtual int32_t& MessageAttenuation() = 0;
    virtual void MessageAttenuationUpdated() = 0;
