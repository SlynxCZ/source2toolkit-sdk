...
#include "CAnimGraph2InstancePtr.h"
#include "CExternalAnimGraphList.h"
...
public:
    ...
    SCHEMA_FIELD(CAnimGraph2InstancePtr, m_pGraphInstanceAG2);
    SCHEMA_FIELD(CExternalAnimGraphList, m_vecExternalGraphs);
};
