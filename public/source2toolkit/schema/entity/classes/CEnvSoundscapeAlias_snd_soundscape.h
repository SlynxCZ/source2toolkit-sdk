...
#ifndef _INCLUDE_CENVSOUNDSCAPEALIAS_SND_SOUNDSCAPE_H
#define _INCLUDE_CENVSOUNDSCAPEALIAS_SND_SOUNDSCAPE_H
...
public:
    ...
    {
        return CBaseEntity::GetHandle<CEnvSoundscapeAlias_snd_soundscape>();
    }
};
